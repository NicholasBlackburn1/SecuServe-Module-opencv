...
class TestKnnClass(unittest.TestCase):
    ...
    def test_training_knn_clasifiyer(self):
        data= __init__.knnClasifiyer.train(train_dir=__init__.TEST_TRAIN_DIR,model_save_path=__init__.TEST_TRAIN_DIR+"test.model",n_neighbors=2)
    ...
    def test_read_knn_classifiyer(self):
        ...
        predict = __init__.knnClasifiyer.predict(__init__.READIMAGE, model_path=__init__.TEST_TRAIN_DIR+"test.model", distance_threshold=0.65)
